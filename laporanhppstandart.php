            ...
            <div class="col-xl-12">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                       <?php 
                       //echo $koneksi;
                          $sql = 'SELECT pesanan.*,sum(hs.total) as harga_jual,pelanggan.nama_pelanggan as pelanggan 
                            FROM pesanan 
                             ...
                             while ($row = mysqli_fetch_array($query))
                                {
                                 ?>
                                  <tr>
                                      ...
                                      <td>
                                          <a class="btn btn-warning" href="laporan_hpp_standart.php?id=<?php echo $row['id'];?>">Detail HPP Standart</a>
                                      </td>                         
                                  </tr>
