...
<h1>Laporan Harga Pokok Produk Aktual</h1>
</div>
</div>
<div class="col-md-12 col-sm-12 content">
    ...
    $sql = 'SELECT pesanan.*,COALESCE(sum(hs.total),0)+((COALESCE(sum(hs.total),0)*pesanan.laba)/100) as harga_jual,pelanggan.nama_pelanggan as pelanggan, COALESCE(sum(hs.total),0) as totalhppa 
                            ...
                            left join hpp_actual hs on hs.id_pesanan = pesanan.id where pesanan.id='.$_GET['id'].' group by pesanan.id';
    ...
    <div class="col-md-3 col-sm-1" style="float: left"><p><strong> <?php  
                ...
                <div class="col-md-6 col-sm-6"><br><strong><span style="font-size: 14px; color: black;">Harga Pokok Poduk Aktual : <?php  
                echo 'Rp.'.number_format($row['totalhppa']);?></span></strong>
                <?php } ?>
                   <!--.$_GET['id']-->
                </div>
        </row>
