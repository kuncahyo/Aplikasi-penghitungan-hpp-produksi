...
<h4> Daftar HPP Actual</h4>
        ...
        <div class="container-fluid">
          ...
          <br><br>
          <form action="design-hpp-aktual.php?id=<?php echo $_GET['id']; ?>" method="post">
            ...
            <div class="card-header py-3">
             ...
             <div class="card-body tab-content" id="myTabContent">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                       <?php 
                          $sql = 'select * from ( SELECT hs.id,p.nama_bb_standar ,p.satuan_bb_standar ,hs.harga,"Bahan Baku" as kategori,
                                 ...
                                 ?>
                                  <tr>
                                    <form class="col-12" role="form" action="updatehppactual.php" method="post" enctype="multipart/form-data">
                                      ...
                                      <!-- <td><button class="btn btn-success" type="submit">Update Data</button></td> -->
                                    </form>
                                      <!-- <td>
