...
<h4> Daftar HPP Standart</h4>
        ...
        <div class="container-fluid">
          ...
          <br><br>
          <a href="design-hpp-standar.php?id=<?php echo $_GET['id']; ?>" class="btn btn-success" >print</a>
            ...
            <div class="card-header py-3">
             ...
             <div class="card-body tab-content" id="myTabContent">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      <?php 
                          $sql = 'select * from ( SELECT p.nama_bb_standar,p.satuan_bb_standar,p.harga_bb_standar,"Bahan Baku" as kategori,hs.qty,hs.total FROM hpp_standart hs 
                             ...
                             while ($row = mysqli_fetch_array($query))
                                {
                                 ?>
                                  <tr>
                                      ...
                                      <td><?php echo $row['harga_bb_standar'];?></td>
                    ...
                    <tbody>
                      <?php 
                          $sql = 'select * from ( 
                                ...
                                SELECT p.nama_tetap_standar,p.harga_tetap_standar,"Overhead Tetap" as kategori,hs.qty,hs.total FROM hpp_standart hs 
                             ...
                             while ($row = mysqli_fetch_array($query))
                                {
                                 ?>
                                  <tr>
                                      ...
                                      <td></td>
                                      <td><?php echo $row['harga_tetap_standar'];?></td>
                                      <td><?php echo $row['qty'];?></td>
                                      <td><?php echo $row['total'];?></td>
                                      <!-- <td>
                                          <a class="btn btn-warning" href="#">Edit</a>
              ...
              <div class="table-responsive tab-pane fade" id="bopt">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                       <?php 
                          $sql = 'select * from ( 
                                SELECT p.nama_variabel_standar,p.satuan_variabel_standar,p.harga_variabel_standar,"Biaya Overhead Variable" as kategori,hs.qty,hs.total FROM hpp_standart hs 
                             ...
                             while ($row = mysqli_fetch_array($query))
                                {
                                 ?>
                                  <tr>
                                      ...
                                      <td><?php echo $row['harga_variabel_standar'];?></td>
                                      <td><?php echo $row['qty'];?></td>
                                      <td><?php echo $row['total'];?></td>
                                      <!-- <td>
                                          <a class="btn btn-warning" href="#">Edit</a>
              ...
              <div class="table-responsive tab-pane fade" id="custom">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                       <?php 
                          $sql = 'select * from ( 
                                SELECT p.nama_custom_standar,p.satuan_custom_standar,p.harga_custom_standar,"Custom" as kategori,hs.qty,hs.total FROM hpp_standart hs 
